...
public class GUI{
    ...
    public GUI(){
        model = new DefaultTableModel(new String[]{"Process", "Arrived", "Burst", "Priority", "Waiting", "Turnaround"}, 0);
        ...
        tatLabel = new JLabel("Average Turnaround Time:");
        ...
        option = new JComboBox(new String[]{"FCFS", "SJF", "SRTF", "PNPS", "PPS", "RR"}); // add CFS
        option.setBounds(390, 420, 85, 20);
        
        computeBtn = new JButton("Schedule");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                for (int i = 0; i < model.getRowCount(); i++){
                    ...
                    if (selected.equals("PSN") || selected.equals("PSP")){
                        if (!model.getValueAt(i, 3).equals("")) pl = Integer.parseInt((String) model.getValueAt(i, 3));
                        else pl = 1;
                    }
                    else pl = 1;                 
